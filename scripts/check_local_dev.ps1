...
# PHP config
$phpCfg = Join-Path $RepoRoot 'site\config\ko2unitydb_config.php'
if (Test-Path $phpCfg) {
    Report -Pass $true -Message 'site/config/ko2unitydb_config.php exists'
} else {
    Report -Pass $false -Message 'Copy site/config/ko2unitydb_config.php.example to ko2unitydb_config.php'
}
