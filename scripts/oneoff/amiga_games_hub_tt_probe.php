...
require __DIR__ . "/../../site/public_html/includes/amiga_games_highlights_helpers.php";
...
foreach (["present","year:2024"] as $as) {
  ...
  echo "=== $as ===\n";
  $t0=microtime(true); amiga_games_hub_recent_tournaments($con,$ctx); echo "  recent_tournaments: ".ms($t0)." ms\n";
  $tournaments=amiga_games_hub_recent_tournaments($con,$ctx);
