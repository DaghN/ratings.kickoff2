...
<ul id="aboutmenu">
        <li><a href="individualA.php?id=<?php if (isset($id)) echo $id ?>" title="" class="current">Profile</a></li>
...
?>
<option value="individual1.php?id=<?php echo $line['id'];?>"> <?php echo $line['name'];?> </option>
<?php
}
?>
</select>
