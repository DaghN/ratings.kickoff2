<?php
/**
 * JSON career Elo rank history for two players (rank comparison chart).
 *
 * GET: id (profile player), opponent, realm=amiga, optional as= (time travel)
 *
 * @see docs/amiga-player-rank-chart-h2h-policy.md
 */
...
$payload = amiga_player_rank_history_compare_payload($con, $playerId, $opponentId, $ctx);
mysqli_close($con);
