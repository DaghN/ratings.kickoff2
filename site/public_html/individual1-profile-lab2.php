...
<title>Kick Off 2 ratings — Profile lab (Agent 2)</title>
...
<link href="stylesheets/player-feast-lab2.css?v=<?php echo (int) @filemtime($_SERVER['DOCUMENT_ROOT'] . '/stylesheets/player-feast-lab2.css'); ?>" rel="stylesheet" type="text/css" />
...
<body class="k2-site player-feast-body player-feast-body--lab2">
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_feast_load_lab2.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_feast_blocks_lab2.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_milestones_helpers.php';

try {
    $pm = player_feast_load_pm_lab2($con, $id);
...
player_feast_render_profile_lab2($pm);
?>
