...
<title>Pass 3 · Composite 3D — <?php echo pm_h($pm['name']); ?></title>
...
pm3d_render_presence($pm);
pm3d_render_played_days($playerId, $calYear);
pm3d_render_peak_activity($pm);
pm3d_render_career($pm);
pm3d_render_moments($pm);
pm3d_render_best_friend($pm);
