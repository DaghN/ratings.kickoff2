...
<ul id="aboutmenu">
        ...
        <li><a href="individualB.php?id=<?php if (isset($id)) echo $id ?>" title="" class="current">Opponents</a></li>
        <li><a href="individualC.php?id=<?php if (isset($id)) echo $id ?>" title="" class="noncurrent">Games</a></li>
</ul>
...
?>
<option value="individual2a.php?id=<?php echo $line['id'];?>"> <?php echo $line['name'];?> </option>
<?php
}
?>
</select>
