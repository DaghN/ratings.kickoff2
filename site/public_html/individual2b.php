...
?>
<option <?php if ($id == $line['id']) { ?> selected="selected" <?php } ?> value="individual2b.php?id=<?php echo $line['id'];?>"> <?php echo $line['name'];?> </option>
<?php
}
?>
</select>
...
<ul id="aboutmenu">
        ...
        <li><a href="individual2b.php?id=<?php echo $id ?>" title="" class="current">Goals</a></li>
