...
<title>Kick Off 2 ratings — Profile lab (Agent 4)</title>
...
<link href="stylesheets/player-feast-lab4.css?v=<?php echo (int) @filemtime($_SERVER['DOCUMENT_ROOT'] . '/stylesheets/player-feast-lab4.css'); ?>" rel="stylesheet" type="text/css" />
...
<body class="k2-site player-feast-body player-feast-body--lab4">
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_feast_load_lab4.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_feast_blocks_lab4.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_milestones_helpers.php';

try {
    $pm = player_feast_load_lab4($con, $id);
...
$pm['heroMilestoneCounts'] = $heroMilestoneCounts;
$pm['heroMsCatalogTotal'] = $heroMsCatalogTotal;
?>
...
player_feast_lab4_render_all($pm);
?>
