...
<title>Pass 3 · Composite 3J — <?php echo pm_h($pm['name']); ?></title>
...
<body class="k2-site pm3d-body pm3efg-body pm3hij-body pm3hij-body--j">
...
pm3d_render_played_days_rhythm($playerId, $calYear, $pm);
pm3d_render_moments($pm);
pm3d_render_best_friend($pm, 'j');
