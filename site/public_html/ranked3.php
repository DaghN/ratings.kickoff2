...
<ul id="aboutmenu">
        ...
        <li><a href="ranked3.php" title="" class="current">DDs and CSs</a></li>
...
$query = "SELECT id, Name, Rating, NumberGames, DoubleDigits, DoubleDigitsConceded, CleanSheets, CleanSheetsConceded, DoubleDigitsRatio, DoubleDigitsConcededRatio, CleanSheetsRatio, CleanSheetsConcededRatio, DifferentOpponents, DoubleDigitsVictims, DoubleDigitsCulprits, CleanSheetsVictims, CleanSheetsCulprits FROM playertable WHERE display=1 AND PlayerRank<>9999 ORDER BY rating DESC";
...
<tfoot>
	<tr> 
		...
		<td colspan="11" style="text-align:center;">Page <span id="tablepage"></span>&nbsp;of <span id="tablepages"></span></td> 
