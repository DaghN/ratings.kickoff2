...
<body class="k2-site player-feast-body player-feast-body--lab3">
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_feast_load_lab3.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/player_feast_blocks_lab3.php';
...
<p class="k2-lab3-banner">Profile lab preview — Agent 3 — not production</p>
...
player_feast_render_presence_lab3($pm);
player_feast_render_character_lab3($pm);
player_feast_render_honours_lab3($pm);
...
player_feast_render_charts($playerId, $pm);
?>
