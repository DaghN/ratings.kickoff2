...
<script type="text/javascript" src="/js/activity-mode-toggle.js?v=<?php echo (int) @filemtime($_SERVER['DOCUMENT_ROOT'] . '/js/activity-mode-toggle.js'); ?>" defer="defer"></script>
