...
<thead>
    <tr>
        ...
        <th<?php echo k2_lb_th(4, $lbSort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_streak_wins(), ENT_QUOTES, 'UTF-8'); ?>">Wins</th>
        <th<?php echo k2_lb_th(5, $lbSort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_streak_undefeated(), ENT_QUOTES, 'UTF-8'); ?>">Undefeated</th>
        <th<?php echo k2_lb_th(6, $lbSort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_streak_draws(), ENT_QUOTES, 'UTF-8'); ?>">Draws</th>
        <th<?php echo k2_lb_th(7, $lbSort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_streak_decided(), ENT_QUOTES, 'UTF-8'); ?>">Decided</th>
        <th<?php echo k2_lb_th(8, $lbSort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_streak_losses(), ENT_QUOTES, 'UTF-8'); ?>">Losses</th>
        <th<?php echo k2_lb_th(9, $lbSort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_streak_win_drought(), ENT_QUOTES, 'UTF-8'); ?>">Win drought</th>
    </tr>
</thead>
