...
<div class="server-goals-month-chart" style="max-width: 780px; margin-bottom: 16px;">
    ...
    <canvas width="780" height="220" aria-label="Server goals per calendar month"></canvas>
</div>
...
<div class="server-cumulative-established-month-chart" style="max-width: 780px; margin-bottom: 16px;">
    ...
    <canvas width="780" height="220" aria-label="Cumulative established players over time by month"></canvas>
</div>

<div class="server-established-rating-distribution-chart" style="max-width: 780px; margin-bottom: 16px;">
