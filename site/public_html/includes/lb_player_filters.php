...
function k2_lb_goals_order_column_map(): array
{
    ...
    return [
        ...
        4 => 'GoalsFor',
        5 => 'GoalsAgainst',
        6 => '(GoalsFor - GoalsAgainst)',
        7 => 'AverageGoalsFor',
        8 => 'AverageGoalsAgainst',
        9 => '(GoalsFor - GoalsAgainst) / NULLIF(NumberGames, 0)',
        10 => $ratio('GoalRatio'),
        11 => 'MostGoalsScored',
        12 => 'MostGoalsConceded',
        13 => 'BiggestWinDifference',
        14 => 'BiggestLossDifference',
        15 => 'BiggestSumOfGoals',
        16 => 'BiggestDrawSum',
    ];
}
...
function k2_lb_victims_order_column_map(): array
{
    return [
        ...
        9 => 'CleanSheetsVictims',
        10 => 'CleanSheetsCulprits',
        11 => 'MostGoalsConcededVictims',
        12 => 'BiggestLossVictims',
