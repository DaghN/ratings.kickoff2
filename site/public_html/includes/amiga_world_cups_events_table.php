...
<thead>
    <tr>
        ...
        <th<?php echo k2_table_sortable_th_attr(4, $defaultSortCol, $defaultSortDir, 'k2-table-cell--center k2-amiga-wc-podium-th-cell k2-wc-events-podium-pad-start'); ?> data-k2-sort="text" data-k2-tooltip-label="Gold"><?php echo amiga_world_cups_events_podium_th(1); ?></th>
        <th<?php echo k2_table_sortable_th_attr(5, $defaultSortCol, $defaultSortDir, 'k2-table-cell--center k2-amiga-wc-podium-th-cell'); ?> data-k2-sort="text" data-k2-tooltip-label="Silver"><?php echo amiga_world_cups_events_podium_th(2); ?></th>
...
<?php foreach ($rows as $row) {
    ...
    <tr>
        ...
        <td<?php echo k2_table_body_td_attr(4, $anchorCol, $defaultSortCol, 'k2-table-cell--left k2-wc-events-podium-pad-start'); ?> data-k2-sort-value="<?php echo k2_h(amiga_world_cups_events_podium_sort_value($goldId, $nameMap)); ?>"><?php echo $goldId < 1 ? k2_fmt_dash() : k2_amiga_lb_player_cell($goldId, k2_player_display_name($nameMap, $goldId), trim($countryMap[$goldId] ?? '')); ?></td>
        <td<?php echo k2_table_body_td_attr(5, $anchorCol, $defaultSortCol, 'k2-table-cell--left'); ?> data-k2-sort-value="<?php echo k2_h(amiga_world_cups_events_podium_sort_value($silverId, $nameMap)); ?>"><?php echo $silverId < 1 ? k2_fmt_dash() : k2_amiga_lb_player_cell($silverId, k2_player_display_name($nameMap, $silverId), trim($countryMap[$silverId] ?? '')); ?></td>
