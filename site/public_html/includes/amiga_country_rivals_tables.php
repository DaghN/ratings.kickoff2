<?php
/**
 * Amiga country Rivals nation-pair tables — W/D/L, Goals, and DDs table bodies.
 *
...
const AMIGA_COUNTRY_RIVALS_TABLE_ANCHOR_COL = 1;
const AMIGA_COUNTRY_RIVALS_TABLE_DEFAULT_SORT_COL = 1;

/** @return array{anchor: int, sort_col: int, sort_dir: string, class: string} */
function amiga_country_rivals_table_sort_state(): array
{
    return [
        'anchor' => AMIGA_COUNTRY_RIVALS_TABLE_ANCHOR_COL,
        'sort_col' => k2_table_default_sort_col_from_request(AMIGA_COUNTRY_RIVALS_TABLE_DEFAULT_SORT_COL),
        'sort_dir' => k2_table_default_sort_dir_from_request('desc'),
        'class' => k2_table_ranked_sortable_class('k2-table--country-rivals'),
    ];
}
 ...
 */
function amiga_country_rivals_table_rows(
    mysqli $con,
    string $heroCountry,
    ...
    $rows = amiga_country_rivals_rows($con, $heroCountry, $ctx, $withPerf);
    if ($rows === []) {
        echo '<p class="k2-hub-page-intro">No rated games vs any rival nation yet.</p>';
 ...
 */
function amiga_country_rivals_render_wdl_table_from_rows(array $rows, string $heroCountry): void
{
    $sort = amiga_country_rivals_table_sort_state();
    ?>
...
<thead>
    <tr>
        <th<?php echo k2_lb_th(0, $sort, 'k2-table-cell--left'); ?> data-k2-sort="text" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_rival(), ENT_QUOTES, 'UTF-8'); ?>">Rival</th>
        <th<?php echo k2_lb_th(1, $sort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_games(), ENT_QUOTES, 'UTF-8'); ?>">Games</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_wins(), ENT_QUOTES, 'UTF-8'); ?>">Wins</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_draws(), ENT_QUOTES, 'UTF-8'); ?>">Draws</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_losses(), ENT_QUOTES, 'UTF-8'); ?>">Losses</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_win_ratio(), ENT_QUOTES, 'UTF-8'); ?>">Win Ratio</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_draw_ratio(), ENT_QUOTES, 'UTF-8'); ?>">Draw Ratio</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_loss_ratio(), ENT_QUOTES, 'UTF-8'); ?>">Loss Ratio</th>
        <th data-k2-sort="number" data-k2-tooltip-label="Performance rating" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_performance_rating(), ENT_QUOTES, 'UTF-8'); ?>">Perf. rating</th>
    </tr>
</thead>
<tbody>
	<?php foreach ($rows as $row) {
	    $rivalToken = (string) $row['rival_token'];
	    $games = (int) $row['games'];
	    $wins = (int) $row['wins'];
	    $draws = (int) $row['draws'];
	    ...
	    ?>
    <tr>
        <td<?php echo k2_lb_td(0, $sort, 'k2-table-cell--left'); ?>><?php echo k2_amiga_lb_country_cell($rivalToken); ?></td>
        <td<?php echo k2_lb_td(1, $sort); ?>><?php echo amiga_country_rivals_games_cell_html($heroCountry, $rivalToken, $games); ?></td>
        <td><?php if ($wins != 0) {
...
function amiga_country_rivals_render_wdl_table(mysqli $con, string $heroCountry, ?AmigaSnapshotContext $ctx = null): void
{
    $rows = amiga_country_rivals_table_rows($con, $heroCountry, $ctx, true);
    if ($rows === null) {
        return;
    }

    amiga_country_rivals_render_wdl_table_from_rows($rows, $heroCountry);
}

/**
 * @param list<array<string, mixed>> $rows
 */
function amiga_country_rivals_render_goals_table_from_rows(array $rows, string $heroCountry): void
{
    $sort = amiga_country_rivals_table_sort_state();
    ?>
<?php k2_table_wrap_open(true); ?>
...
<thead>
    <tr>
        <th<?php echo k2_lb_th(0, $sort, 'k2-table-cell--left'); ?> data-k2-sort="text" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_rival(), ENT_QUOTES, 'UTF-8'); ?>">Rival</th>
        <th<?php echo k2_lb_th(1, $sort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_games(), ENT_QUOTES, 'UTF-8'); ?>">Games</th>
        <th data-k2-sort="number" data-k2-tooltip-label="Goals for" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_goals_for(), ENT_QUOTES, 'UTF-8'); ?>">GF</th>
        <th data-k2-sort="number" data-k2-tooltip-label="Goals against" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_goals_against(), ENT_QUOTES, 'UTF-8'); ?>">GA</th>
...
function amiga_country_rivals_render_goals_table(mysqli $con, string $heroCountry, ?AmigaSnapshotContext $ctx = null): void
{
    $rows = amiga_country_rivals_table_rows($con, $heroCountry, $ctx);
    if ($rows === null) {
        return;
    }

    amiga_country_rivals_render_goals_table_from_rows($rows, $heroCountry);
}

/**
 * @param list<array<string, mixed>> $rows
 */
function amiga_country_rivals_render_dds_table_from_rows(array $rows, string $heroCountry): void
{
    $sort = amiga_country_rivals_table_sort_state();
    ?>
<?php k2_table_wrap_open(true); ?>
...
<thead>
    <tr>
        <th<?php echo k2_lb_th(0, $sort, 'k2-table-cell--left'); ?> data-k2-sort="text" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_rival(), ENT_QUOTES, 'UTF-8'); ?>">Rival</th>
        <th<?php echo k2_lb_th(1, $sort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_games(), ENT_QUOTES, 'UTF-8'); ?>">Games</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_double_digits(), ENT_QUOTES, 'UTF-8'); ?>">Double Digits</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_clean_sheets(), ENT_QUOTES, 'UTF-8'); ?>">Clean Sheets</th>
        ...
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_double_digits_conceded(), ENT_QUOTES, 'UTF-8'); ?>">DD conceded</th>
        <th data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_amiga_country_rivals_clean_sheets_conceded(), ENT_QUOTES, 'UTF-8'); ?>">CS conceded</th>
...
function amiga_country_rivals_render_dds_table(mysqli $con, string $heroCountry, ?AmigaSnapshotContext $ctx = null): void
{
    $rows = amiga_country_rivals_table_rows($con, $heroCountry, $ctx);
    if ($rows === null) {
        return;
    ...
    amiga_country_rivals_render_dds_table_from_rows($rows, $heroCountry);
}
