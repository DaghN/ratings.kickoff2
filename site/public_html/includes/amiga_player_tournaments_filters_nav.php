...
$k2PlayerTournamentsEventTabs = [
    'all' => [
        'href' => amiga_player_tournaments_filter_url($k2PlayerTournamentsPlayerId, 'all', $k2PlayerTournamentsCountryFilter, $k2PlayerTournamentsYearFilter),
        'label' => 'All',
    ],
    'world-cup' => [
        'href' => amiga_player_tournaments_filter_url($k2PlayerTournamentsPlayerId, 'world-cup', $k2PlayerTournamentsCountryFilter, $k2PlayerTournamentsYearFilter),
        'label' => 'World Cups',
    ],
];
