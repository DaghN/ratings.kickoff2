...
include $_SERVER["DOCUMENT_ROOT"] . "/includes/k2_experiments.php";
$k2HeaderBannerExperiment = !empty($k2Experiments['header_banner']);
?>
<header class="k2-site-header<?php echo $k2HeaderBannerExperiment ? ' k2-site-header--banner-experiment' : ''; ?>">
<?php if ($k2HeaderBannerExperiment) { ?>
	<h1 class="k2-wordmark k2-wordmark--banner">
		<a href="status.php" class="k2-wordmark__link">
			<img class="k2-wordmark__banner" src="images/KO2Banner.png" width="420" height="80" alt="Kick Off 2" decoding="async" />
		</a>
	</h1>
<?php } else { ?>
