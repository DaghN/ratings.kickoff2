...
function k2_post_game_player_to_db_row(array $st, int $playerId): array
{
    ...
    return [
        ...
        'ScoreStreak' => (int) $st['score_streak'],
        'MerchantStreak' => (int) $st['merchant_streak'],
        'ExactTenGoalStreak' => (int) $st['exact_ten_goal_streak'],
        'WinMarginOneStreak' => (int) $st['win_margin_one_streak'],
        'LossMarginOneStreak' => (int) $st['loss_margin_one_streak'],
