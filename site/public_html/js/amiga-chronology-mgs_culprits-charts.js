/**
 * MGS Culprits chronology graphs — inline payload from graphs.php.
 */
(function () {
    'use strict';
    ...
    function readPayload() {
        var el = document.getElementById('k2-amiga-chronology-mgs_culprits-chart-data');
    ...
    function maybeShowEmptyNote(totalUnlocks, label) {
        ...
        note.hidden = false;
        note.textContent = 'No MGS culprits yet. The charts below span the Amiga rated era (zero unlocks so far).';
    }
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                ...
                                return n + (n === 1 ? ' MGS culprit' : ' MGS culprits');
                            }
                        }
                    })
                },
                ...
                plugins: {
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                return 'Total MGS culprits: ' + item.parsed.y;
                            }
                        }
                    })
                },
