/**
 * Countries faced chronology graphs — inline payload from graphs.php. — inline payload from graphs.php.
 */
(function () {
    'use strict';
    ...
    function readPayload() {
        var el = document.getElementById('k2-amiga-chronology-countries-faced-chart-data');
    ...
    function maybeShowEmptyNote(totalUnlocks, label) {
        ...
        note.hidden = false;
        note.textContent = 'No countries faced yet. The charts below span the Amiga rated era (zero unlocks so far).';
    }
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                ...
                                return n + (n === 1 ? ' country faced' : ' countries faced');
                            }
                        }
                    })
                },
    ...
    function initCumulativeChart(root, data) {
        ...
        new Chart(canvas, {
            ...
            data: {
                datasets: [Object.assign({
                    label: 'Cumulative countries faced',
                    data: chartData,
                    fill: true,
                    stepped: true,
                    pointRadius: 0,
                ...
                plugins: {
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                return 'Total countries faced: ' + item.parsed.y;
                            }
                        }
                    })
                },
