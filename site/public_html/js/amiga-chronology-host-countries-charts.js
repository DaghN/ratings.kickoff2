/**
 * Host countries chronology graphs — inline payload from graphs.php. — inline payload from graphs.php.
 */
(function () {
    'use strict';
    ...
    function readPayload() {
        var el = document.getElementById('k2-amiga-chronology-host-countries-chart-data');
    ...
    function maybeShowEmptyNote(totalUnlocks, label) {
        ...
        note.hidden = false;
        note.textContent = 'No host countries yet. The charts below span the Amiga rated era (zero unlocks so far).';
    }
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                ...
                                return n + (n === 1 ? ' host country' : ' host countries');
                            }
                        }
                    })
                },
    ...
    function initCumulativeChart(root, data) {
        ...
        new Chart(canvas, {
            ...
            data: {
                datasets: [Object.assign({
                    label: 'Cumulative host countries',
                    data: chartData,
                    fill: true,
                    stepped: true,
                    pointRadius: 0,
                ...
                plugins: {
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                return 'Total host countries: ' + item.parsed.y;
                            }
                        }
                    })
                },
