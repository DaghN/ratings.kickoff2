/**
 * DD Victims chronology graphs — inline payload from graphs.php.
 */
(function () {
    'use strict';
    ...
    function readPayload() {
        var el = document.getElementById('k2-amiga-chronology-dd-victims-chart-data');
    ...
    function maybeShowEmptyNote(totalUnlocks, label) {
        ...
        note.hidden = false;
        note.textContent = 'No DD victims yet. The charts below span the Amiga rated era (zero unlocks so far).';
    }
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                ...
                                return n + (n === 1 ? ' DD victim' : ' DD victims');
                            }
                        }
                    })
                },
                ...
                plugins: {
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                return 'Total DD victims: ' + item.parsed.y;
                            }
                        }
                    })
                },
