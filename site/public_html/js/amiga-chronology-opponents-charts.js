/**
 * Opponents chronology graphs — inline payload from graphs.php.
 */
(function () {
    'use strict';
    ...
    function readPayload() {
        var el = document.getElementById('k2-amiga-chronology-opponents-chart-data');
    ...
    function maybeShowEmptyNote(totalUnlocks, label) {
        ...
        note.hidden = false;
        note.textContent = 'No opponents yet. The charts below span the Amiga rated era (zero unlocks so far).';
    }
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                ...
                                return n + (n === 1 ? ' opponent' : ' opponents');
                            }
                        }
                    })
                },
                ...
                plugins: {
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                return 'Total opponents: ' + item.parsed.y;
                            }
                        }
                    })
                },
