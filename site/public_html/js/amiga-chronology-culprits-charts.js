/**
 * Culprits chronology graphs — inline payload from graphs.php. — inline payload from graphs.php.
 */
(function () {
    'use strict';
    ...
    function readPayload() {
        var el = document.getElementById('k2-amiga-chronology-culprits-chart-data');
    ...
    function maybeShowEmptyNote(totalUnlocks, label) {
        ...
        note.hidden = false;
        note.textContent = 'No culprits yet. The charts below span the Amiga rated era (zero unlocks so far).';
    }
                ...
                plugins: {
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                return 'Total culprits: ' + item.parsed.y;
                            }
                        }
                    })
                },
