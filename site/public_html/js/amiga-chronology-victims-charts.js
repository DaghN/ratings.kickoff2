/**
 * Victims chronology graphs — inline payload from graphs.php.
 */
(function () {
    'use strict';
    ...
    function readPayload() {
        var el = document.getElementById('k2-amiga-chronology-victims-chart-data');
    ...
    function maybeShowEmptyNote(totalUnlocks, label) {
        ...
        note.hidden = false;
        note.textContent = 'No victims yet. The charts below span the Amiga rated era (zero unlocks so far).';
    }
                ...
                plugins: {
                    ...
                    tooltip: T.mergeTooltip({
                        callbacks: {
                            ...
                            label: function (item) {
                                return 'Total victims: ' + item.parsed.y;
                            }
                        }
                    })
                },
