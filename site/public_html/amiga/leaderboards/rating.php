...
<?php $lbSort = k2_lb_table_sort_state(2); ?>
<table class="<?php echo k2_h(k2_table_ranked_leaderboard_class()); ?>" data-k2-table="sortable" data-k2-autorank="true" data-k2-anchor-col="<?php echo $lbSort['anchor']; ?>" data-k2-default-sort="<?php echo $lbSort['sort_col']; ?>" data-k2-default-direction="<?php echo k2_h($lbSort['sort_dir']); ?>"<?php echo k2_table_skip_initial_sort_attr(2); ?>>
...
<thead>
    <tr>
        ...
        <th<?php echo k2_lb_th(5, $lbSort, ''); ?> data-k2-sort="number">Wins</th>
        <th<?php echo k2_lb_th(6, $lbSort, ''); ?> data-k2-sort="number">Draws</th>
        <th<?php echo k2_lb_th(7, $lbSort, ''); ?> data-k2-sort="number">Losses</th>
        <th<?php echo k2_lb_th(8, $lbSort, ''); ?> data-k2-sort="number">Win %</th>
        <th<?php echo k2_lb_th(9, $lbSort, ''); ?> data-k2-sort="number" data-k2-help="<?php echo htmlspecialchars(k2_lb_help_opponent_avg(), ENT_QUOTES, 'UTF-8'); ?>">Opp. avg.</th>
    </tr>
</thead>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <tr>
        ...
        <td<?php echo k2_lb_td(3, $lbSort); ?>><?php echo k2_h($row['Country']); ?></td>
        <td<?php echo k2_lb_td(4, $lbSort); ?>><?php echo k2_fmt_games_played($games); ?></td>
        <td<?php echo k2_lb_td(5, $lbSort); ?>><?php echo k2_fmt_count($row['NumberWins'], $games); ?></td>
        <td<?php echo k2_lb_td(6, $lbSort); ?>><?php echo k2_fmt_count($row['NumberDraws'], $games); ?></td>
        <td<?php echo k2_lb_td(7, $lbSort); ?>><?php echo k2_fmt_count($row['NumberLosses'], $games); ?></td>
        <td<?php echo k2_lb_td(8, $lbSort); ?>><?php echo k2_fmt_pct_from_ratio($row['WinRatio'], $games); ?></td>
