...
$highlightScope = amiga_games_highlights_valid_scope((string) ($_GET['scope'] ?? 'all'));

$con = k2_db_connect_or_public_error($dbhost, $username, $password, $database, $dbportnum);
$ctx = amiga_lb_context($con);

$highlightRows = amiga_games_highlights_fetch($con, $highlightBoard, $ctx, AMIGA_GAMES_HIGHLIGHTS_LIMIT, $highlightScope);
...
?>
	<div id="<?php echo AMIGA_GAMES_HIGHLIGHTS_ANCHOR; ?>" class="k2-games-highlights-cluster">
		<?php amiga_games_render_highlights_board_filter($highlightBoard, $highlightScope); ?>
		<?php amiga_games_render_highlights_table($highlightRows, $highlightBoard, $highlightScope); ?>
	</div>
