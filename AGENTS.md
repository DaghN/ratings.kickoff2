...
- **K2 quiet date columns** — avoid **first-load date blast**; prefer **ID default**; fallback **`k2-table-col-quiet-date`** only when table must open Date-sorted without game ID ([`k2-table-quiet-date-column-policy.md`](docs/k2-table-quiet-date-column-policy.md)). User-chosen Date sort → normal emphasis. Plan: [`k2-table-quiet-date-unification-plan.md`](docs/k2-table-quiet-date-unification-plan.md).
