...
| When | Note |
|------|------|
| 2026-06-23 | **WC table CSS consolidation** — `.k2-hub-sortable-table` shell; dropped duplicate wing CSS; tournament stats on `ranked-pages-table` + `k2-table--world-cup-stats` overrides. |
