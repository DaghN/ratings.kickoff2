...
| 2026-06-26 | **WC Videos deep-link policy** — [`k2-embedded-video-page-policy.md`](docs/k2-embedded-video-page-policy.md): `v=` playback, optional `game=`, Back/index/cold-final rules; Phase A/B; expandable for profile Videos later. Slice **TV-URL** in implementation plan. |
