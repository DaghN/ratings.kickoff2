...
- **Amiga tournament videos (Jun 2026):** **TV-3 shipped** — Videos tab + manifest **298** videos (incl. **23** KO2CV live streams manually mapped). **TV-4** next. Bulk-verify UI deferred. [`amiga-tournament-videos-implementation-plan.md`](docs/amiga-tournament-videos-implementation-plan.md).
