...
| Date | Note |
|------|------|
| 2026-07-14 | **Amiga Games Highlights fix** — `lean_join_sql()` now bundles fixture/stage LEFT JOINs (stage-first phase SELECT); fixes fatal `Unknown column s.name` on `/amiga/games/highlights.php`. |
