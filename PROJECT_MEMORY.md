...
| When | Note |
|------|------|
| 2026-06-24 | **Amiga WC hub URL parity** — wing 1 → **Chronology** at `/amiga/world-cups/chronology/` (root + stats folder `index.php` 302); Tournament stats Goals → `stats/goals.php`. |
