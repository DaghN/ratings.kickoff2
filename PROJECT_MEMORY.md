...
| 2026-07-04 | **Amiga realm full census** — `scripts/oneoff/amiga_realm_full_census_probe.php` · 96 paths/APIs ranked; results `scripts/oneoff/amiga_realm_full_census_results.md` · 3 pages >0.8 s (player games HTML, country rivals). |
