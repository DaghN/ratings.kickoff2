...
- **Amiga format scoring contract (Jul 2026):** **SC-1 shipped** — `scoring_contract.py` + copy-on-create on `create_stage` / PHP fixtures. **Next:** SC-2 (structural verify CLI). Policy [`amiga-format-scoring-contract-policy.md`](docs/amiga-format-scoring-contract-policy.md) · plan [`amiga-format-scoring-contract-implementation-plan.md`](docs/amiga-format-scoring-contract-implementation-plan.md).
