...
- **Amiga tournament videos (Jun 2026):** **TV-3 shipped** — manifest **~299** videos; unified embed UI on all events with clips. **Human review sign-off (Jun 2026):** tournaments index + orphan→tournament assignment queues complete — no obvious misplacements; orphans page retains tutorials / general KO2 / excluded audit only. Next: **TV-4** Chronology clip indicator (With videos filter shipped). [`amiga-tournament-videos-policy.md`](docs/amiga-tournament-videos-policy.md).
