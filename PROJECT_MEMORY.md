...
| 2026-07-04 | **Amiga realm full census (post batch 1–2 refresh)** — 96 paths/APIs; **1 flagged >0.8 s** (`player/games.php?id=382` **1.09 s** HTML-bound). Next feel debt: country rivals h2h/wdl **~0.75 s** @ late TT, games/recent **0.57 s**, games hub cluster **0.4–0.46 s**, LB present wings **0.21–0.30 s**, CvC chart APIs **0.2–0.28 s**. Results `scripts/oneoff/amiga_realm_full_census_results.md`. |
