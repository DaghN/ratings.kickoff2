...
CREATE TABLE `amiga_community_stat_facts` (
  ...
  `period_type` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
  `period_key` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
  `slice_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `slice_key` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `metric_key` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `count_basis` enum('game','participant') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `amiga_community_stats_snapshots` (
  ...
  `tournament_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `amiga_country_slice_at_event` (
  `country_token` varchar(128) COLLATE utf8mb4_general_ci NOT NULL,
  `slice_key` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `amiga_generalstats` (
  ...
  `MostGamesPlayedName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWinsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostGoalsScoredName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostGoalsScoredInOneGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestWinDifferenceName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestDrawSumNameA` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestDrawSumNameB` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestSumOfGoalsNameA` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestSumOfGoalsNameB` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostDoubleDigitsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostCleanSheetsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostDifferentOpponentsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostDifferentVictimsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostDoubleDigitsVictimsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostCleanSheetsVictimsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestRatingAscentName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostGamesPlayedDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostWinsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostGoalsScoredDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostGoalsScoredInOneGameDate` mediumtext COLLATE utf8mb4_general_ci,
  `BiggestWinDifferenceDate` mediumtext COLLATE utf8mb4_general_ci,
  `BiggestDrawSumDate` mediumtext COLLATE utf8mb4_general_ci,
  `BiggestSumOfGoalsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostDoubleDigitsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostCleanSheetsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostDifferentOpponentsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostDifferentVictimsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostDoubleDigitsVictimsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostCleanSheetsVictimsDate` mediumtext COLLATE utf8mb4_general_ci,
  `BiggestRatingAscentDate` mediumtext COLLATE utf8mb4_general_ci,
  ...
  `BiggestWinRatioName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestGoalsForAverage` decimal(6,4) DEFAULT NULL,
  `BiggestGoalsForAverageID` int DEFAULT NULL,
  `BiggestGoalsForAverageName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SmallestGoalsAgainstAverage` decimal(6,4) DEFAULT NULL,
  `SmallestGoalsAgainstAverageID` int DEFAULT NULL,
  `SmallestGoalsAgainstAverageName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestGoalRatio` decimal(7,4) DEFAULT NULL,
  `BiggestGoalRatioID` int DEFAULT NULL,
  `BiggestGoalRatioName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestDoubleDigitsRatio` decimal(5,4) DEFAULT NULL,
  `BiggestDoubleDigitsRatioID` int DEFAULT NULL,
  `BiggestDoubleDigitsRatioName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestCleanSheetsRatio` decimal(5,4) DEFAULT NULL,
  `BiggestCleanSheetsRatioID` int DEFAULT NULL,
  `BiggestCleanSheetsRatioName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostGamesInOneYear` int DEFAULT NULL,
  `MostGamesInOneYearID` int DEFAULT NULL,
  `MostGamesInOneYearName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostGamesInOneYearDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostTournamentsInOneYear` int DEFAULT NULL,
  `MostTournamentsInOneYearID` int DEFAULT NULL,
  `MostTournamentsInOneYearName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostTournamentsInOneYearDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostTournamentsPlayed` int DEFAULT NULL,
  `MostTournamentsPlayedID` int DEFAULT NULL,
  `MostTournamentsPlayedName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostTournamentsPlayedDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostTournamentWins` int DEFAULT NULL,
  `MostTournamentWinsID` int DEFAULT NULL,
  `MostTournamentWinsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostTournamentWinsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostPerfectEvents` int DEFAULT NULL,
  `MostPerfectEventsID` int DEFAULT NULL,
  `MostPerfectEventsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostPerfectEventsDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostCountriesPlayedIn` int DEFAULT NULL,
  `MostCountriesPlayedInID` int DEFAULT NULL,
  `MostCountriesPlayedInName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostCountriesPlayedInDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostOpponentCountriesFaced` int DEFAULT NULL,
  `MostOpponentCountriesFacedID` int DEFAULT NULL,
  `MostOpponentCountriesFacedName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostOpponentCountriesFacedDate` mediumtext COLLATE utf8mb4_general_ci,
  `MostOpponentCountriesBeaten` int DEFAULT NULL,
  `MostOpponentCountriesBeatenID` int DEFAULT NULL,
  `MostOpponentCountriesBeatenName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostOpponentCountriesBeatenDate` mediumtext COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `amiga_player_event_snapshots` (
  ...
  `best_knockout_phase` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `amiga_tournament_standings` (
  ...
  `tournament_id` int NOT NULL,
  `player_id` int NOT NULL,
  `scope_type` enum('league','knockout') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'league',
  `scope_key` varchar(120) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
) ENGINE=InnoDB AUTO_INCREMENT=48191 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `amiga_wc_hof_present` (
  ...
  `MostWcPlayedName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcGoldName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcGamesName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcWinsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcPointsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcPtsPerGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcWinRateName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcGoalsForName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcGoalsForPerGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcGoalsAgainstPerGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcGoalDiffPerGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcGoalRatioName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcDoubleDigitsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcDoubleDigitsRatioName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcCleanSheetsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestWcCleanSheetsRatioName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcOpponentsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcVictimsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcDoubleDigitsVictimsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcCleanSheetsVictimsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcGoalsInOneGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestWcWinDifferenceName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestWcDrawSumNameA` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestWcDrawSumNameB` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestWcSumOfGoalsNameA` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BiggestWcSumOfGoalsNameB` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcBestAttackAwardsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MostWcBestDefenseAwardsName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestSingleWcGoalsForPerGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BestSingleWcGoalsAgainstPerGameName` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `amiga_world_cup_stats` (
  ...
  `event_date` date DEFAULT NULL,
  `event_chrono` double DEFAULT NULL,
  `host_country` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `host_city` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tournament_entrants` (
  ...
  `status` enum('registered','withdrawn','replaced') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'registered',
...
CREATE TABLE `tournament_fixtures` (
  ...
  `fixture_key` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `player_a_id` int DEFAULT NULL,
  `player_b_id` int DEFAULT NULL,
  `leg_no` smallint NOT NULL DEFAULT '1',
  `status` enum('scheduled','played','void') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'scheduled',
  `phase_label` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=17425 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tournament_stage_players` (
  ...
  `player_id` int NOT NULL,
  `seed_no` smallint DEFAULT NULL,
  `group_key` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tournament_stage_scoring_steps` (
  ...
  `step` enum('points','head_to_head','goal_difference','goals_for','games_played','aggregate_goal_difference','extra_time','penalty_shootout','golden_goal') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tournament_stages` (
  ...
  `stage_key` varchar(80) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `stage_type` enum('round_robin','knockout') COLLATE utf8mb4_general_ci NOT NULL,
  `track_key` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sequence_no` smallint NOT NULL DEFAULT '0',
  `config_json` longtext COLLATE utf8mb4_general_ci,
  `scoring_primitive` enum('league_table','knockout_tie') COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `frozen_scoring_primitive` enum('league_table','knockout_tie') COLLATE utf8mb4_general_ci DEFAULT NULL,
