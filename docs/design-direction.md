...
| H2H goals-per-game histogram | Grouped bars: `T.chrome()` (you) + `T.tableNegative()` (rival) | Shared x-axis 0..max of either player’s peak GF in the pairing; Profile stays single `T.amber()` series |
