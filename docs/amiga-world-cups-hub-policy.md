...
| **WCH13** | **WC detection** | **Planned:** stored `tournaments.is_world_cup` ([`amiga-world-cup-flag-policy.md`](amiga-world-cup-flag-policy.md) **WC8**). **Until ship:** `amiga_tournament_is_world_cup()` / name `^World Cup\s+\S`. |
