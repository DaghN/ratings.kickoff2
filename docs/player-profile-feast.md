...
1. Site header + **hero** (name, rank, rating, games; **milestones** column with `{n}/{catalog}` then tier subcounts when `NumberGames >= 1` — links to garden tab; catalog via `k2_milestone_catalog_total()`)
2. Feast **pills**
