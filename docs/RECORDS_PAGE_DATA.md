...
- **Activity peaks** (“most games in one year/month/week/day”): value → `ranked8.php#k2-peak-period-{day|week|month|year}` — scrolls that panel into view (`scroll-margin-top` + `activity-mode-toggle.js` ensures Calendar tab is shown).
