...
Dagh opens a **new** Cursor agent chat and pastes the RESUME block from `docs/orchestration/agent-handoffs/amiga-tournament-structure-STARTER-PROMPT.md`. No manual git steps for Dagh.
