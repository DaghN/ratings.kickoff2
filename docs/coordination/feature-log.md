...
| Amiga player hero country flags | — | — | — | — | — | — | Country stat column (label + flag) on player profile/tournaments/games; `k2_amiga_country_flag.php`; **Jun 2026-25:** UAE host-country token added (`ae.svg`) |
...
| Amiga World Cups player slice V2 | L1 | `039_player_slice_v2` | — | **Done** local Jun 2026-23 (`verify-player-slice` V2 + `prove` green) | **Export ready** (browser import pending) | — | Writers + **five sub-wing UI** (hub + LB dual surface) — [`amiga-world-cups-player-slice-v2-policy.md`](../amiga-world-cups-player-slice-v2-policy.md) |
| Amiga World Cups hub (universe tab) | L0 | — | — | **Wings 1–4 shipped** Jun 2026-24; wing 1 **Chronology** URL Jun 2026-24 | **Export ready** (sync `public_html`) | — | [`amiga-world-cups-hub-policy.md`](../amiga-world-cups-hub-policy.md) |
| Amiga World Cup per-event stats table | L1 | `037_world_cup_stats` + `038_world_cup_stats_blowout_intl` | — | **Done** — writers + wing 2 UI; `prove` green Jun 2026-23 (intl + `blowout_rate`) | **Export ready** (browser import pending) | — | [`amiga-world-cup-stats-table-plan.md`](../amiga-world-cup-stats-table-plan.md) §3.13 |
...
| Amiga World Cups LB honours wing | L0 | — | — | **Done** slice 1 local | **Export ready** (browser import pending) | — | Shared body with hub wing 3 (`amiga_wc_players_wing_body.inc.php`) |
| Amiga World Cups LB Results + Goals | L0 | — | — | **Done** slices 2–3 local | **Export ready** (browser import pending) | — | Dual surface with hub player stats; WC extracted from tournament honours + calendar-geo |
...
| Amiga tournament Games table (comprehensive) | L0 | — | — | — | — | — | **Jun 2026-26** — `/amiga/tournament/games.php` re-backed by `amiga_rated_games_from_sql()`; full sortable scoreboard (ID · Player A · A · B · Player B · GD · Sum · TS · Rating A/B · Elo Diff · Fav ES · Adjustment), conditional player flags (≥2 countries), winner-goal emphasis, no date/order col; `amiga_tournament_render_games_table()` |
...
| Amiga tournament Videos tab | L0 | — | — | **Shipped** local Jun 2026 | **Export ready** (sync `public_html` + manifest JSON) | — | Manifest read-only; `/amiga/tournament/videos.php?id=`; lazy YouTube embed — [`amiga-tournament-videos-policy.md`](../amiga-tournament-videos-policy.md) |
...
| Amiga time travel hub IA (T13–T19) | L0 | — | — | **Done** local Jun 2026 | **Not executed** | — | Snapshot-only TT hub; **T19** fixed mode-toggle homes; T17 pre-debut; T18 player event stepper; atmospheric chrome §5.0; Event ribbon §5.1.1 — [`amiga-time-travel-policy.md`](../amiga-time-travel-policy.md) |
