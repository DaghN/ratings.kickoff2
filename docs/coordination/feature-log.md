...
| Amiga career `elo_rank` at finalize | L1 | `032` (`scripts/amiga/sql/derived/032_elo_rank.sql`) | — | **Done** local Jun 2026 (`prove` green) | **Not executed** | — | Hero UI reads `elo_rank`; **profile rank chart shipped** Jun 2026 (API + chart + TT); LB wings still enumerate |
