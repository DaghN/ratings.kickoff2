...
| Amiga ground layers L0–L5 (modular pipeline) | — | `sql/ground|structure|derived` = L3–L5 DDL | — | Slice 1 done; policy v2 Jun 2026 | — | — | [`amiga-ground-layers-policy.md`](../amiga-ground-layers-policy.md) |
