...
| Amiga World Cup per-event stats table | L1 | `037_world_cup_stats` | — | **Done** local (`verify-world-cup-stats` Jun 2026-23, 23 WC rows) | **Export ready** (browser import pending) | — | Wide row per WC; podium from knockout standings oracle — [`amiga-world-cup-stats-table-plan.md`](../amiga-world-cup-stats-table-plan.md) |
