...
| Amiga career `elo_rank` at finalize | L1 | `032` (`scripts/amiga/sql/derived/032_elo_rank.sql`) | — | **Done** local Jun 2026 (`prove` green) | **Not executed** | — | Hero UI reads `elo_rank`; **rank chart policy** [`amiga-player-rank-chart-policy.md`](../amiga-player-rank-chart-policy.md) — API/UI not started; LB wings still enumerate |
