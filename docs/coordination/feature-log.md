...
| With player stepper filter | L0 | — | — | **Done** local Jun 2026-30 | **Not executed** | — | Opt-in **`as_with=`** / **`id_with=`** / **`start_with=`** on TT Event ribbon, tournament chevrons, league periods; T18 retired slice 0 — [`with-player-stepper-policy.md`](../with-player-stepper-policy.md) |
