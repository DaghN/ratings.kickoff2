...
| Amiga TT temporal stamp motion (2a) | L0 | — | — | **Done** local Jun 2026-24 | **Not executed** (Amiga staging) | — | Ambient cursor blink; tier-1 toggle arrival (fade + kicker typewriter) — `k2-amiga-tt-stamp.js`; tiers 2–4 deferred |
