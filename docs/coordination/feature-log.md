...
| Amiga World Cups hub (universe tab) | L0 | — | — | **Wings 1–4 shipped** Jun 2026-24 (events catalog + stats + player + country wings) | **Export ready** (sync `public_html`) | — | [`amiga-world-cups-hub-policy.md`](../amiga-world-cups-hub-policy.md) |
