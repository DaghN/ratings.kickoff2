...
| Amiga community stats v2 (ko2amiga_db) | L1 | `036_community_stats_v2` + v2 fact registry | — | **Done** local (`verify-community-stats` + `verify-php-community-parity`; **Jul 2026** +4 nationality grains incl. `wc_active_players`, **`prove` green**) | **Export ready** (browser import pending) | — | Activity chart tooltips on stored facts; **49** catalog Q-IDs — [`amiga-community-stats-question-catalog.md`](../amiga-community-stats-question-catalog.md) |
...
| Amiga Activity charts sub-hub (6 wings, 49 panels) | L0 | — | — | — | — | — | **Shipped Jul 2026** — `/amiga/activity/` base track (slices 0–10) + **Nations player grains** + **Texture low-scoring rate** (Q-TEX-014; registry + re-prove); TT via `as=` — [`amiga-activity-charts-policy.md`](../amiga-activity-charts-policy.md) |
