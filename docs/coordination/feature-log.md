...
| Amiga holy loop (`prove`) | L0 | `apply_schema` bundle `001–013`, `019`, `024` | — | **Done** local Jun 2026 | **Not executed** | — | Nuclear-only path: `python -m scripts.amiga prove`; incremental import gated — [`amiga-import-layer.md`](../amiga-import-layer.md) |
...
| Amiga historical rating ladder | L0 | — | — | — | **Not executed** (Amiga staging) | — | `/amiga/history.php` — Event / Month / Year wings; Δ column; compute-on-read `amiga_rating_events` — [`amiga-rating-history-policy.md`](../amiga-rating-history-policy.md) |
...
| Amiga event snapshots (player truth) | L1 | `024` (`scripts/amiga/sql/`) | — | **Done** slices 0–7 local | **Not executed** | — | Present=`current`; history/race=snapshots; dual-write until slice 8 — [`amiga-event-snapshot-policy.md`](../amiga-event-snapshot-policy.md) |
