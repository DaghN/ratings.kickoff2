...
| Amiga holy loop (`prove`) | L0 | `apply_schema` bundle `001–013`, `019`, `024`, `026`, `027`, `032`, `033`, **`034`**, **`035`**, **`036`**, **`037`**, **`038`**, **`039`**, **`040`** | — | **Done** local Jun 2026-23 (fresh nuclear) | **Not executed** | — | Nuclear-only path: `python -m scripts.amiga prove`; incremental import gated — [`amiga-import-layer.md`](../amiga-import-layer.md) |
...
| Amiga career `elo_rank` at finalize | L1 | `032` (`scripts/amiga/sql/derived/032_elo_rank.sql`) | — | **Done** local Jun 2026 (`prove` green) | **Not executed** | — | Hero UI reads `elo_rank`; **profile rank chart shipped** Jun 2026 (API + chart + TT); **Jun 2026 UX polish** — Linear/Percentile only, stepped clip, empty-band axes; LB wings still enumerate |
