...
| Amiga ground layers L0–L3 (modular pipeline) | — | — | — | — | — | — | **Slice 0 docs** Jun 2026 — witness/structure/derived split; community packs A/B/C; impl plan slices 1–7 — [`amiga-ground-layers-policy.md`](../amiga-ground-layers-policy.md) |
| Amiga holy loop (`prove`) | L0 | `apply_schema` bundle `001–013`, `019`, `024`, `026` | — | **Done** local Jun 2026 | **Not executed** | — | Nuclear-only path: `python -m scripts.amiga prove`; incremental import gated — [`amiga-import-layer.md`](../amiga-import-layer.md) |
