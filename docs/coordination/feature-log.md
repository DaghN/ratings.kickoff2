...
| Amiga World Cups hub (universe tab) | L0 | — | — | **Wings 2–3 shipped** Jun 2026-23 (player stats = five sub-wings) | **Export ready** (sync `public_html`) | — | [`amiga-world-cups-hub-policy.md`](../amiga-world-cups-hub-policy.md) |
