...
| Amiga holy loop (`prove`) | L0 | `apply_schema` bundle `001–013`, `019`, `024`, `026`, `027`, `032`, `033`, **`034`**, **`035`**, **`036`**, **`037`** | — | **Done** local Jun 2026-23 (fresh nuclear) | **Not executed** | — | Nuclear-only path: `python -m scripts.amiga prove`; incremental import gated — [`amiga-import-layer.md`](../amiga-import-layer.md) |
...
| Amiga World Cups hub (universe tab) | L0 | — | — | **Wing 2 shipped** — five stats sub-wings Jun 2026-23; wing 1 + 3 placeholder | **Export ready** (sync `public_html`) | — | [`amiga-world-cups-hub-policy.md`](../amiga-world-cups-hub-policy.md) |
| Amiga World Cup per-event stats table | L1 | `037_world_cup_stats` | — | **Done** — writers + wing 2 UI (5 sub-wings; geography intl step 2 backlog) | **Export ready** (browser import pending) | — | [`amiga-world-cup-stats-table-plan.md`](../amiga-world-cup-stats-table-plan.md) §3.13 |
...
| Amiga World Cups LB honours wing | L0 | — | — | **Done** slice 1 local | **Export ready** (browser import pending) | — | `world-cups/honours.php` + slice read libs + TT; smoke [`amiga_wc_lb_smoke.php`](../scripts/oneoff/amiga_wc_lb_smoke.php) |
| Amiga World Cups LB Results + Goals | L0 | — | — | **Done** slices 2–3 local | **Export ready** (browser import pending) | — | `world-cups/results.php` · `goals.php`; WC extracted from tournament honours + calendar-geo |
