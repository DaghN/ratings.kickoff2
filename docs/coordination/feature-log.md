...
| Amiga time travel hub IA (T13–T18) | L0 | — | — | **Done** local Jun 2026 | **Not executed** | — | Snapshot-only TT hub; T14b player entry; T17 pre-debut; T18 player event stepper — [`amiga-time-travel-policy.md`](../amiga-time-travel-policy.md) |
