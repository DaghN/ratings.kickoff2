...
| Amiga Countries hub (career roster) | L0 | — | — | **Policy locked** Jun 2026; UI not started | **Not executed** | — | Hub tab + index + roster; read-time aggregation; TT; v2 country vs country — [`amiga-countries-hub-policy.md`](../amiga-countries-hub-policy.md) |
