...
| REP-014 | Milestone definitions catalog | Load `milestone_definitions` from seed JSON | **Done** (May 2026) | **Done** (May 2026) | **Pending** | `ops/run_prepare.php seed-catalog` (`local-work` / `local-dev`); Python `scripts/oneoff/load_milestone_definitions.py`. Staging legacy: deprecated `load_milestone_definitions.php` (staging-data seed). **112** rows in seed Jun 2026. |
