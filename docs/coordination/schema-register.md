...
| SCH-009 | `008_league_period_awards.sql` | Create `league_period`, `player_league_award`, `player_league_totals` | **Done** (May 2026) | **Done** (May 2026) | **Pending** | Yes (REP-012) | Rules: `docs/leagues-rules-spec.md`; staging applied `staging-sql/008` + historical `run_league_awards_rebuild.php` (superseded by `ops/run_finalize_league.php`). |
