...
**Status:** Five chrono facilitators **implemented** (Jun 2026, SCH-018). Post-game PHP updates columns in P2 and unlocks in P6 (`k2_post_game_milestones_streak_keys`).
...
**Migration:** `schema/migrations/018_playertable_milestone_streak_facilitators.sql` · contract `docs/website-data-contract.md` · oracle `scripts/ladder/player_state.py`.
