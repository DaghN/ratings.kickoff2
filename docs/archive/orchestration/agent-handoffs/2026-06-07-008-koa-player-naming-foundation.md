...
- `docs/archive/orchestration/amiga-tournament-orchestration-model.md` — note internal CLI shipped, public UX deferred
- `docs/archive/orchestration/agent-handoffs/2026-06-07-008-koa-player-naming-foundation.md` — this handoff
...
#  M docs/archive/orchestration/amiga-tournament-orchestration-model.md
