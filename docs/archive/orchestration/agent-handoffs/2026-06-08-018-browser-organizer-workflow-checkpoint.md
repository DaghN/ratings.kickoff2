...
- `docs/archive/orchestration/amiga-tournament-architecture-checkpoint.md` — strategic context

## Files changed

- `docs/archive/orchestration/browser-organizer-workflow-checkpoint.md` — new checkpoint (diagnosis, happy path, views, mapping, league-first rules, hide/demote, navigation, non-goals, phased plan, prompt-019 spec)
- `docs/archive/orchestration/agent-handoffs/2026-06-08-018-browser-organizer-workflow-checkpoint.md` — this handoff
...
See full acceptance criteria in `docs/archive/orchestration/browser-organizer-workflow-checkpoint.md` §10.
...
3. Update `docs/archive/orchestration/amiga-tournament-architecture-checkpoint.md` job sequence when 019 is scheduled.
