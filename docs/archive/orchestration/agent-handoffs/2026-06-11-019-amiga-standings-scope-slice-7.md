...
| `docs/archive/orchestration/agent-handoffs/amiga-standings-scope-STARTER-PROMPT.md` | COMPLETE |
...
| `docs/archive/orchestration/browser-organizer-workflow-checkpoint.md` | `league` scope |
