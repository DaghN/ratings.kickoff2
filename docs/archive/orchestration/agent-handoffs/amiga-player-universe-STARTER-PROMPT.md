...
- Write a handoff file: `docs/archive/orchestration/agent-handoffs/2026-06-08-0XX-player-universe-slice-N.md` (pick next free number) with: goal, checklist done, files changed, verification results, known limitations, next slice hint.
