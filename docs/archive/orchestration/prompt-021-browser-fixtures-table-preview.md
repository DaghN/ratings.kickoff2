...
`docs/archive/orchestration/browser-organizer-workflow-checkpoint.md`
...
Implement Phase C from `docs/archive/orchestration/browser-organizer-workflow-checkpoint.md`.
...
- `docs/archive/orchestration/browser-organizer-workflow-checkpoint.md`
- `docs/archive/orchestration/agent-handoffs/2026-06-08-019-browser-organizer-shell.md`
- `docs/archive/orchestration/agent-handoffs/2026-06-08-020-browser-friendly-lifecycle.md`
...
- `docs/amiga-data-contract.md`
- `scripts/amiga/README.md`
- `docs/archive/orchestration/browser-organizer-workflow-checkpoint.md` only if implementation intentionally diverges from the plan

Create handoff:

`docs/archive/orchestration/agent-handoffs/2026-06-08-021-browser-fixtures-table-preview.md`
