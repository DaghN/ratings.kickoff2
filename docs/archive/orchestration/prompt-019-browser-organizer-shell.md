...
Implement the first slice from `docs/archive/orchestration/browser-organizer-workflow-checkpoint.md` section 10.
...
- `docs/archive/orchestration/agent-handoffs/2026-06-08-018-browser-organizer-workflow-checkpoint.md`
