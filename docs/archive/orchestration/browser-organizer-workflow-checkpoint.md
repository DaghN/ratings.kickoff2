...
- Prior browser ops: handoffs 014–017 in `docs/archive/orchestration/agent-handoffs/`
- Architecture checkpoint: `docs/archive/orchestration/amiga-tournament-architecture-checkpoint.md`
