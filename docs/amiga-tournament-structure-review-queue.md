...
- **323** Ostersund VI → `pure_rr` — 7p incomplete double-RR **League** (56g, NULL phase); Bjorn P + Kent H withdrew early ([forum t=14454](https://ko-gathering.com/forum/viewtopic.php?t=14454&start=65)); Access catalog `player_count`=5 (witness only; hero shows derived 7). **Jul 2026:** `materialize --replace --force` (pairing-coverage guard); 1 stage / 56g; `has_league=1` `has_cup=0`; Tier B finish **1 John H (17-0-0) · 2 Jacob K · 3 Niclas L · 4 Mattias N · 5 Nick P · 6 Bjorn P · 7 Kent H**.
