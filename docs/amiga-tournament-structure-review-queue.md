...
- **54** Kristiansand → `structure_spec` — 8p 2×4 group RR + KO playoffs (g1183–90); forum p=48040. **Jul 2026:** manual materialize; **SC-11:** g1189 `0-0` + ET `1-0`; g1188 `0-0` ET + pens **7–8** (Glenn wins bronze — forum order Oskar–Glenn); finish 1 Klaus · 2 Aasmund · **3 Glenn** · **4 Oskar** · 5 Kjetil · 6 Jens · 7 Jon · 8 Gisle.
...
- **145** Milan V → `structure_spec` — 2×4 groups (Sandro T withdrew) + variable-leg KO incl. Play Outs + placement finals; AET/pens g5159, g5178, g5180, g5187. **Jul 2026:** parser fix (Play Outs · Finals plural · Nth Place Finals); `materialize --replace`; 11 stages / 54 fixtures; **Group A/B** · **Quarter Finals** (×3) · **Semi Finals** (×2) · **Play Outs** · **Final** (4 legs) · **3rd Place Final** · **5th Place Final**; `has_league=1` `has_cup=1`; Tier B finish **1 Gianni · 2 Luigi · 3 Mario · 4 Maurizio · 5 Alessandro · 6 Jacopo · 7 Marco**; Tier E **8 Sandro T** (withdrew).
