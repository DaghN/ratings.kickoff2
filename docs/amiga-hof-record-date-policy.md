...
| Most perfect events | `perfect_events` | `perfect_events_last_rise_tournament_id`, `perfect_events_last_rise_event_date` — policy [`amiga-perfect-event-policy.md`](amiga-perfect-event-policy.md) (SCH-045) |
