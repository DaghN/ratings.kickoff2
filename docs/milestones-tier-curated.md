...
| `monthly_regular` | **Monthly regular** | 4 | Rated game on every day of a calendar month | 5 | 4.7% |
| `ultra_day_30` | **Server overload** | 4 | 30 rated games in one UTC day | 5 | 4.7% |
| `club_2300` | **Summit club** | 5 | Rating ≥2300 | 6 | 5.6% |
| `merchant_denied` | **Merchant denied** | 5 | Lost 10–9 | 6 | 5.6% |
| `win_streak_30` | **Untouchable** | 5 | 30 wins in a row | 6 | 5.6% |
| `leaky_merchant` | **Leaky merchant** | 5 | 10+ scored and 9 conceded | 7 | 6.5% |
...
| `club_2000` | **2000 club** | 4 | Rating ≥2000 | 26 | 24.3% |
...
| `dozen_dash` | **Dozen dash** | 4 | Scored 12+ in one game | 31 | 29.0% |
...
| `battle_hardened` | **Battle-hardened** | 4 | 5-5 or higher draw | 60 | 56.1% |
...
| `dd_merchant_10` | **Double Digit Merchant** | 5 | Scored 10+ in one game | 44 | 41.1% |
...
| `club_1800` | **1800 club** | 4 | Rating ≥1800 | 38 | 35.5% |
| `millennium_merchant_1000` | **Millennium merchant** | 5 | 1,000 rated games | 37 | 34.6% |
| `goal_fest_draw` | **Goal fest draw** | 4 | 7-7 or higher draw | 37 | 34.6% |
...
| `victim_of_commerce` | **Victim of commerce** | 5 | Conceded 10+ goals | 121 | 113%+ |
...
| `hat_trick` | **Hat-trick** | 4 | 3+ goals in one game | 156 | 146%+ |
